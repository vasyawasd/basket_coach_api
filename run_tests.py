...
def test_full_system():
    ...
    # 3. Test Plan Generation with Model Selector (claude-sonnet-5)
    print("\n[4/6] Testing Plan Generation with Model 'claude-sonnet-5'...")
    payload = {
        "height": 195,
        "weight": 90,
        "position": "SG",
    ...
    for _ in range(30):
        time.sleep(3)
        r_status = requests.get(f"{BASE_URL}/plan_status/{task_id}")
        st = r_status.json()
    ...
    assert task_success, "Plan generation timed out after 90 seconds"
