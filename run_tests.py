...
def test_full_system():
    ...
    print("\n[1/7] Testing 3-Stage Security Hashing Pipeline (SHA256 -> Salt -> Bcrypt)...")
    ...
    print("\n[2/7] Testing OWASP HTTP Security Headers...")
    ...
    print(f"\n[3/7] Testing User Registration ('{test_user}')...")
    ...
    print("\n[5/7] Testing Plan Generation with Ping Probe Cascade...")
    payload = {
        "height": 195,
        "weight": 90,
        "position": "SG",
    ...
    print("\n[6/7] Testing User History Persistence in SQLite...")
    ...
    print("\n[7/7] Testing History Deletion Security...")
